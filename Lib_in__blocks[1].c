...
int choice;
    ...
    // a Function for the Admin to add staff
    void actionMini(){
            int option;
            int choice;
            char staffUser[20];
    ...
    //closes the text file
                ...
                exit();
                 ...
                 //  this code changes the content of the file
    ...
    void admin(){
        ...
        if(pin1==1234){
             //if password is correct it calls the function that displays the menu to the admin
                 actionMini();
        }
        else
    ...
    //shows all books availbale in the system
    void books (){
    ...
    int counter2;
         ...
         fprintf(fptr ,"1.Introduction to C by Bwana Titus\n 2.When Icoded a monkey by Liam\n 3.Practice karate by Lee\n");
         fclose(fptr);
         printf("Welcome\n");
        ...
        if(optionz >0 && optionz < 4){
            //allows the user to choose hwo many books he wants
    switch(optionz){
        case 1:
...
void exit(){
    printf("Thank you for visiting us and welcome back \n");
